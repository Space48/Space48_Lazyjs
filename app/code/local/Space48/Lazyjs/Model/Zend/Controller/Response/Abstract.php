 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Space48_Lazyjs_Model_Zend_Controller_Response_Abstract
{
    /**
     * Body content
     * @var array
    ...
    /**
     * Space48 additional processing to change the page HTML before it's finally sent to browser
     *
     * @param $body string
     * @return string
     */
    protected function _space48OutputBody($body = '')
    {
        if (!class_exists('Space48_Lazyjs_Model_Observer')) {
            return $body;
        }

        $processor = new Space48_Lazyjs_Model_Observer();

        return $processor->beforeSendResponse($body);
    }
    ...
    public function outputBody()
    {
        ...
        $body = $this->_space48OutputBody($body);
